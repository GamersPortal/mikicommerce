                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_4">
                            ...
                            <div class="form-group">
                                {!! Form::label('file', trans('product.product_file'), ['class' => 'col-lg-2 control-label']) !!}
                                <div class="col-lg-10">
                                    {!! Form::file('file', null, ['class' => 'form-control','required'=>'required', 'placeholder' => trans('product.product_file')]) !!}
                                </div>
                            </div><!--form control-->
