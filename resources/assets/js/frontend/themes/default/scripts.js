        ...
        if (winWidth > 1024) {
            ...
            if (imgWidth != 0) {
                ...
                parallaxContainer.css({
                    '-webkit-transform': 'translateY(' + parOfs + 'px)',
                    '-moz-transform': 'translateY(' + parOfs + 'px)',
                    '-ms-transform': 'translateY(' + parOfs + 'px)',
                    'transform': 'translateY(' + parOfs + 'px)',
                    'left': +leftOfs + 'px'
                });
            }
            ;
            ...
            parallaxContainer.css({
                'left': '0px',
                '-webkit-transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2) + 'px)',
                '-moz-transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2) + 'px)',
                '-ms-transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2) + 'px)',
                'transform': 'translateY(' + parseInt((img.height() - bgobj.outerHeight()) / -2) + 'px)'
            });

            if (img.height() < parallaxContainer.height()) {
                img.css('width', img.width() * (bgobj.outerHeight() / img.height()));
                parallaxContainer.css({
                    'left': +parseInt((img.width() - parallaxContainer.width()) / -2) + 'px',
...
$(function () {
    ...
    jQuery(document).ready(function () {
        window.slider_bg = {
            "ind": 0, // index to start sliding at
    ...
    function parallaxCarousel() {
        setTimeout(function () {
            $('#testimonials-carousel').parent().parent().parallax();
        }, 300)
    }
